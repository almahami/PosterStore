...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 06. Apr 2021 um 13:49
...
(305, 64, '96.97', '2021-04-05'),
(306, 64, '96.97', '2021-04-05'),
(307, 64, '96.97', '2021-04-06');
...
(2, '12121', 'Elefant', 'schwarz weiß elefant', 'elefant.jpg', '12.00', '{21 x 31 cm ', 6, 'animals/tiere'),
...
(14, 'ro111', 'Schiefe Turm', 'Faszinierendes Architekturposter von dem Schiefen Turm von Pisa. Der Glockenturm ist aufgrund seiner Schieflage ein beliebtes Ziel von Touristen aus der ganzen Welt. Das Architekturposter in seinen hellen beigen Farben lässt sich schön kombinieren und mac', 'Schiefe_Turm.jbg', '12.00', ' 70 x100 cm', 10, 'city/staedte'),
...
INSERT INTO `user` (`id`, `firstname`, `lastname`, `email`, `password`, `verification_code`, `status`, `online`, `screen_size`) VALUES
(60, 'MOHAMMAD', 'MAHAMID', 'almahamid98@gmail.com', '1b86355f13a7f0b90c8b6053c0254399994dfbb3843e08d603e292ca13b8f672ed5e58791c10f3e36daec9699cc2fbdc88b4fe116efa7fce016938b787043818', 'GHJIKL', 1, 0, '2000X1334'),
(64, 'poster', 'store', 'posterStore9@gmail.com', '1b86355f13a7f0b90c8b6053c0254399994dfbb3843e08d603e292ca13b8f672ed5e58791c10f3e36daec9699cc2fbdc88b4fe116efa7fce016938b787043818', 'WXYZ', 1, 0, '2000X1334');
...
(21, 64, 'Frau', 'poster', 'store', '64', 'Hechinger Straße 66', 'tübingen', 'de');
...
--
ALTER TABLE `order_`
  MODIFY `OrderID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=308;
